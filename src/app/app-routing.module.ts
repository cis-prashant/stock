...
import { AuthGuard, GuestGuard } from './helpers';
...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'optionStrategy',
        component: OptionStrategyComponent,  canActivate : [AuthGuard],
      },
      {
        path: 'createOptionStrategy',
        component: CretateOptionStrategyComponent,  canActivate : [AuthGuard],
      },
      {
        path: 'user',
  ...
  {
    path: 'register',
    component: RegisterComponent, canActivate : [GuestGuard],
    data: {
      title: 'Register Page'
    }
  },
